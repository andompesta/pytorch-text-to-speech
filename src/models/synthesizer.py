...
class Synthesizer(torch.nn.Module):
    def __init__(
        ...
        self.max_wav_value = self.preprocess_config["preprocessing"]["audio"]["max_wav_value"]
    ...
    def build(
        ...
        mel_generator_config = yaml.load(open(mel_generator_config_path, "r"), Loader=yaml.FullLoader)
        voice_generator_config = yaml.load(open(voice_generator_config_path, "r"), Loader=yaml.FullLoader)
