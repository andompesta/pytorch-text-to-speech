...
if __name__ == "__main__":
    ...
    example_inputs = dict(
        ...
        pitch_control=float(args.pitch_control),
        energy_control=float(args.energy_control),
        duration_control=float(args.duration_control)
    )
    
    synthesizer.forward(**example_inputs)

    jit_module = torch.jit.script(
        synthesizer
    )
